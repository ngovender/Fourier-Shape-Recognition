...
%     disp(trainingImage2(i,:));
    ...
    % centre of the image
    diffDistX = abs(sizeX - trainingImage1(i,1));
    diffDistY = abs(sizeY - trainingImage1(i,2));
    distance = [diffDistX;diffDistY];
    % difference in angles
    angleImage1 = abs(refAngle - trainingImage1(i,4));
...
%     disp(trainingImage2(i,3));
    ...
    % Image 2
    angleImage2 = abs(refAngle - trainingImage2(i,4)); % angle used for voting
    diffAngle = abs(angleImage1 - angleImage2);
    % rotation matrix
